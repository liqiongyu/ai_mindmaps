...
Provide an opt-in, real-network sanity check that validates Azure OpenAI connectivity and SDK configuration without running LLM calls in the default unit test suite.
